...
surreal-subproc test --algorithm ddpg --num_agents 1 --num_evals 1 --env robosuite:SawyerPickPlaceMultiTaskTarget -- --restore-folder /Users/fanghongyu/Desktop/Black_Hole/material/I_love_study/实验室/毕设/experiment/exp/tmux/sppsglmttct-pick-ddpg-na8-nopix/checkpoint/
