...
#python -u subproc/surreal_subproc.py sppmtt-pick-ddpg-na4-nopix --algorithm ddpg --num_agents 4 --num_evals 1 --env robosuite:SawyerPickPlaceMultiTaskTarget #-- --restore-folder ../../../exp/sppsglmttct-pick-ddpg-na8-nopix/checkpoint/
