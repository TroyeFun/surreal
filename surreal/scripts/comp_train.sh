...
#python -u subproc/surreal_subproc.py sppsglmtt-placeik-ddpg-na4-nopix --algorithm ddpg --num_agents 4 --num_evals 1 --env robosuite:SawyerPickPlaceSingleMultiTaskTarget -- --restore-folder ../../../exp/sppsglmttct-pick-ddpg-na8-nopix/checkpoint/
