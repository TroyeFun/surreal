...
#python -u subproc/surreal_subproc.py sppsglmttct-ddpg-na8-nopix --algorithm ddpg --num_agents 4 --num_evals 1 --env robosuite:SawyerPickPlaceSingleMultiTaskTarget -- --restore-folder ../../../exp/sppsglmttct-ddpg-na8-nopix/checkpoint/
