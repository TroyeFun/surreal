...
python -u subproc/surreal_subproc.py sppsglmtt-ppo-na8-nopix --algorithm ppo --num_agents 8 --num_evals 1 --env robosuite:SawyerPickPlaceSingleMultiTaskTarget #-- --restore-folder ../../../exp/sppsglmtt-ddpg-na4-nopix-fs1/checkpoint/
#python -u subproc/surreal_subproc.py sppmtt-ddpg-na8-nopix --algorithm ddpg --num_agents 8 --num_evals 1 --env robosuite:SawyerPickPlaceMultiTaskTarget #-- --restore-folder ../../../exp/sppsglmtt-ddpg-na4-nopix-fs1/checkpoint/
#python -u subproc/surreal_subproc.py sppsglmttct-ddpg-na8-nopix --algorithm ddpg --num_agents 8 --num_evals 1 --env robosuite:SawyerPickPlaceSingleMultiTaskTarget #-- --restore-folder ../../../exp/sppsglmtt-ddpg-na4-nopix-fs1/checkpoint/
