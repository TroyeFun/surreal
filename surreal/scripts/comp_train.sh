...
python -u subproc/surreal_subproc.py sppmtt-placeintrain-ddpg-na4-nopix-nstep20 --algorithm ddpg --num_agents 4 --num_evals 1 --env robosuite:SawyerPickPlaceMultiTaskTarget -- --restore-folder ../../../exp/sppmtt-placeintrain-ddpg-na4-nopix/checkpoint/
