...
surreal-tmux create test --algorithm ddpg --num_agents 2 --num_evals 1 --env robosuite:SawyerPickPlaceSingleMultiTaskTarget #-- --restore-folder ../../../exp/sppsglmtt-ddpg-na4-nopix-fs1/checkpoint/
