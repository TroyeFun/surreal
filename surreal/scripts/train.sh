...
surreal-tmux create sppsglmtt-ddpg-na4-pcd --algorithm ddpg --num_agents 4 --num_evals 1 --env robosuite:SawyerPickPlaceSingleMultiTaskTarget #-- --restore-folder ../../../exp/sppsglmtt-ddpg-na4-nopix-fs1/checkpoint/
