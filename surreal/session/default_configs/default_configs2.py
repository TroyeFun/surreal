...
LOCAL_SESSION_CONFIG = {
    ...
    'ps': {
        ...
        'parameter_serving_frontend_port': 9005,
        'parameter_serving_backend_host': 'localhost',
        'parameter_serving_backend_port': 9006,
        'shards': 2,
